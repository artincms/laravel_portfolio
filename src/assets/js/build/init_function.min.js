...
//init validator js
function init_validatejs(form, constraints, function_name, selector_loader_area, selector_submit_button, console_log) {
    var console_log = console_log || false;
    var selector_submit_button = selector_submit_button || false;
    // Hook up the form so we can prevent it from being posted
    selector_loader_area = selector_loader_area || '#' + form.id;
    if (selector_submit_button) {
        var submits = form.querySelectorAll(" button[type=submit]" + selector_submit_button);
    }
    else {
